			...
			for currentA = 1:number_of_particles
				...
				while !is_position_ok
					...
					if position_constraint_axis == "x"
						if position_constraint_lower * Lx_prim <= x_star <= position_constraint_upper * Lx_prim
							is_position_ok = true
						end				
					elseif position_constraint_axis == "y"
						if position_constraint_lower * Ly_prim <= y_star <= position_constraint_upper * Ly_prim
							is_position_ok = true
						end		
					elseif position_constraint_axis == "z"
						if position_constraint_lower * Lz_prim <= z_star <= position_constraint_upper * Lz_prim
							is_position_ok = true
						end		
					end
				end
