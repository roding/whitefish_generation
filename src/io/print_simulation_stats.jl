function print_simulation_stats(particles::String, number_of_particles::Int64, number_of_diffusers::Int64, Lx::Float64, Ly::Float64, Lz::Float64, numbers_of_cells_x::Int64, numbers_of_cells_y::Int64, numbers_of_cells_z::Int64)
	println("Simulation stats:")
	println(join(("   Particle type:               ", particles)))
